...
public class StudyGroup implements Comparable<StudyGroup>{
    ...
    public StudyGroup(Integer id,String name, Coordinates coordinates, java.util.Date creationDate ,Long studentsCount, int transferredStudents, FormOfEducation formOfEducation, Semester semesterEnum, Person groupAdmin){
        this.id = id;
        this.name = name;
